...
const Reg = () => {
  ...
  >
    ...
    <p className=" sm:text-[40px] text-[20px] font-[Poppins] text-[white] font-light capitalize mb-[9px] max-lg:text-center ">
      {" "}
      Welcome aboard NEXZERO CTF, where the spirit of daring hack3rs
      meets the stealthy artistry of ninjas!
    </p>
    <p className="font-light capitalize font-[Poppins] sm:text-[25px] text-[15px] text-[#F05323] max-lg:text-center">
      Ready to set sail into the challenges that lie ahead?Click to join
      the crew, where minds are connected, and data is secured.
    </p>
    <a
      className={` flex justify-center items-center bg-[#F05323] text-[#1F1F1F] text-[26px]  font-bold capitalize font-good-times rounded-[20px] max-w-[315px]  text-center max-sm:text-[15px] px-2 h-[74px] cursor-pointer mt-[51px]`}
    >
      register now
    </a>
  </div>
